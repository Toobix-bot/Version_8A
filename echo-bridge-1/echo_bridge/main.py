...
Wenn du bereit bist, mit diesen drei Bausteinen zu beginnen, lass es mich wissen! Ich kann dir helfen, die Implementierung zu skizzieren oder spezifische Fragen zu beantworten. Das wird definitiv dazu beitragen, die Bridge schnell in einen funktionsfähigen Zustand zu versetzen.