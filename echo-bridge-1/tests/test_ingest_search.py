...
Wenn du bereit bist, mit diesen drei Bausteinen zu beginnen, lass es mich wissen! Ich kann dir helfen, die Implementierung zu skizzieren oder spezifische Fragen zu beantworten. Das wird auf jeden Fall dazu beitragen, die Bridge schnell einsatzbereit zu machen und die Funktionalität zu testen.