...
Start-Process -FilePath 'C:\GPT\Version_8\\echo-bridge\\.venv\\Scripts\\python.exe' -ArgumentList 'run_mcp_http.py','--host','0.0.0.0','--port','3337' -WorkingDirectory 'C:\GPT\Version_8\\echo-bridge' -RedirectStandardOutput $outLog -RedirectStandardError $errLog -NoNewWindow | Out-Null
